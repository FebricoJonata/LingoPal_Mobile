...
class choiChipEdit extends StatelessWidget {
  choiChipEdit({super.key});
  var controller = Get.find<ChoiceEditController>();
  @override
  Widget build(BuildContext context) {
    return GetBuilder<ChoiceEditController>(builder: (controller) {
      return Column(
