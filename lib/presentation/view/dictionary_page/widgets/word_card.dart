              ...
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text(wordforCard, style: TextStyle(color: MyColors.secondaryYellow, fontSize: 60.sp, fontWeight: FontWeight.bold),),
                          SizedBox(width: 50.w,),
                          IconButton(
                            onPressed: () {
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              Text(entry.meanings[index].description, softWrap: true, textAlign: TextAlign.justify,
                ...
                ListView.separated( 
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if(checkExamples){
                      ...
                      return Text(finalSentence, softWrap: true, textAlign: TextAlign.justify,);
                    }
                    else {
                      return null;
                    }
                ...
                SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text("Synonyms", style: TextStyle(fontWeight: FontWeight.bold),),
                      SizedBox(width: 50.w,),
                      Expanded(
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            return Text(entry.synonyms[index], style: TextStyle(color: MyColors.primaryGreen, fontWeight: FontWeight.bold),);
                          }, 
                          separatorBuilder: ((context, index) {return SizedBox(width: 50.w,);})),
                      )
                    ],
                  ),
                ),
                ...
                Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Text("Antonyms", style: TextStyle(fontWeight: FontWeight.bold),),
                    SizedBox(width: 50.w,),
                    SizedBox(
                      height: 50.h,
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Text(entry.antonyms[index], style: TextStyle(color: MyColors.primaryGreen, fontWeight: FontWeight.bold),);
                        }, 
                        separatorBuilder: ((context, index) {return SizedBox(width: 50.w,);})),
                    )
                  ],
